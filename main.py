...
<div style="font-family: Arial, sans-serif; text-align: center;">
    <h1>Juegos de Steam - Proyecto Individual N1</h1>
...
@app.get("/MostPlayedYearForGenre/{genre}", tags=['Consultas sobre Steam Games'])
...
def  recomendacion_juego(item_id:int):
    ...
    "Lista de juegos recomendados similares al juego con ID 12345."
    ```
    INSTRUCCIONES DE USO<br>
                            1. Haz clic en "Try it out".<br>
    ...
    try:
        ...
        respuesta = {
            "Juego Consultado": game['item_name'].iloc[0],
